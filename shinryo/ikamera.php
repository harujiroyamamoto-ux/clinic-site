<?php
$page_title = '本牧で胃カメラ｜鎮静剤対応・消化器専門医';
$page_description = '本牧(横浜市中区)の山本内科クリニックでは鎮静剤を使った苦痛の少ない胃カメラを実施。胃痛・胸焼け・ピロリ菌・健診で胃炎を指摘された方など、消化器専門医がしっかり診断します。';
$page_css = 'page.css';
include __DIR__ . '/../partials/head.php';
?>

<div class="breadcrumb container">
  <a href="/">ホーム</a> &raquo; <a href="/shinryo/index.php">診療案内</a> &raquo; <a href="/shinryo/naishikyo.php">内視鏡検査</a> &raquo; 胃カメラ検査
</div>

<section class="page-header">
  <div class="container">
    <h1>胃カメラ検査（上部内視鏡検査）</h1>
    <p class="page-lead">
      食道・胃・十二指腸の粘膜を直接観察する検査です。胃がんは早期発見・早期治療によって
      良好な経過が期待できる病気ですが、初期には自覚症状が乏しいことも少なくありません。
...
<section class="content-section">
  <div class="container">
    <div class="local-appeal-box">
      <h2>本牧・山手・根岸エリアで胃カメラをお探しの方へ</h2>
      <p>横浜市中区本牧にある山本内科クリニックでは、消化器内視鏡専門医が鎮静剤を使った苦痛の少ない胃カメラ（上部内視鏡）を実施しています。平成3年の開院以来35年以上、本牧・小港地区の方々の消化器検査に対応してきました。</p>
      <ul>
        <li>所在地：横浜市中区本牧町2-364（バス停「小港前」より徒歩圏）</li>
        <li>駐車場完備・土曜日の検査にも対応</li>
    ...
    <div class="notice-box">
      <p>
        ...
        病理検査に提出する組織の数や、その他の診療内容によって変動します。
        初診料などが別途かかる場合があります。正確な金額は受付でご確認ください。
      </p>
    </div>
    ...
    <div class="notice-box">
      <p>
        検査は予約制です。当日の食事制限やお薬の調整など、事前確認が必要な事項がありますので、
        まずは受付までお電話でご相談ください。
      </p>
    </div>
    ...
    <div class="cta-box">
      ...
      <a href="/shinryo/daichokamera.php" class="btn btn-primary">大腸カメラ検査について</a>
    </div>
  </div>
</section>
