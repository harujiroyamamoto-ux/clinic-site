<?php
$page_title = '症状から探す｜本牧の内科・消化器内科';
$page_description = '「なんとなく調子が悪い」「これって病院に行くべき?」その症状、心当たりはありませんか。かぜ・胃腸・循環器・呼吸器・訪問診療など、気になる症状から考えられる原因や受診の目安を、一つずつ丁寧にわかりやすくご紹介しています。';
$page_css = 'page.css';
