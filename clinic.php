<?php
$page_title = 'クリニック紹介';
$page_description = '山本内科クリニックの院内・設備のご紹介と、関連施設（たんぽぽ訪問看護ステーション・ヘルパーチームえがお）のご案内です。';
$page_css = 'page.css';
include __DIR__ . '/partials/head.php';
?>

<div class="breadcrumb container">
  <a href="/index.php">ホーム</a> &raquo; クリニック紹介
</div>
...
<section class="content-section">
  <div class="container">
    ...
    <div class="card-grid">
      ...
      <div class="img-placeholder">クリニック外観の写真<br>（準備中）</div>
    </div>
    <p>
